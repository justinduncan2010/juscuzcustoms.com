          ...
          <form class="form-horizontal form-custom" method="post" >
            ...
            <div class="registerbox">
              ...
              <?php 
				...
				?> <script type="text/javascript"> alert('You have successfully entered the User'); window.history.go(-2);</script>
                <?php } ?>
              <input class="btn btn-orange" onClick="client.php" name="submit" id="submit" type="submit" value="Update Information" />
